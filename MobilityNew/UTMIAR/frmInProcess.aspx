<%@ Page Title="ACAD2016." Language="C#" MasterPageFile="~/UTMIAR/UTMIRMasterPage.master" AutoEventWireup="true" CodeFile="frmInProcess.aspx.cs" Inherits="UTMIAR_frmInProcess" %>
             ...
             <ItemStyle Width="3%" />
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("APP_APPID") %>'
                        OnClick="ViewStatus">
                        <span class="fa fa-info-circle fa-lg"></span></asp:LinkButton>
                </ItemTemplate>

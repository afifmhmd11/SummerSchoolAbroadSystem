<%@ Page Title="" Language="C#" MasterPageFile="~/UTMIAR/UTMIRMasterPage.master" AutoEventWireup="true" CodeFile="frmViewStudApp.aspx.cs" Inherits="UTMIAR_frmViewStudApp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" Runat="Server">
    ...
    <div class="name-bgcolor">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/UTMIAR/frmViewForm.aspx" Font-Bold="True" onclick="window.open (this.href, 'popupwindow', 'width=1300,height=700, scrollbars, resizable'); return false;"><i class="fa fa-file-text fa-lg" style="color:maroon"></i>&nbsp;View Full Application Form</asp:HyperLink>
            </div>
        </div>
        <div class="statfiller">
        </div>
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td>
                Date : <asp:Label ID="lblDeanDate" runat="server" Font-Bold="True"></asp:Label>
            </td>
        </tr>
        <tr>

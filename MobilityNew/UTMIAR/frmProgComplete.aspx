<%@ Page Title="ACAD2016." Language="C#" MasterPageFile="~/UTMIAR/UTMIRMasterPage.master" AutoEventWireup="true" CodeFile="frmProgComplete.aspx.cs" Inherits="UTMIAR_frmProgComplete" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" Runat="Server">
    <div id="cssmenu2">
        <ul style="font-size: small">
            ...
            <li class="active"><a><span class="fa fa-check fa-lg"></span>&nbsp;Completed</a></li>
        </ul>
    </div>
    <table style="float: right">
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Text="" Font-Bold="True">Progamme <span class="fa fa-arrow-right"></span>&nbsp;Completed Programme</asp:Label>
            </td>
        </tr>
    </table>
    <br>
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td style="background-color: #FFFBD6">Summer School</td>
            <td style="background-color: #FFFBD6">Summer Camp 2016</td>
            <td style="background-color: #FFFBD6">Universitas Maritim Raja Ali Haji</td>
            <td style="background-color: #FFFBD6">47</td>
        </tr>
    </table>
    <br />

<%@ Page Title="ACAD2016." Language="C#" MasterPageFile="~/UTMIAR/UTMIRMasterPage.master" AutoEventWireup="true" CodeFile="frmAddNewProg.aspx.cs" Inherits="UTMIAR_frmAddNewProg" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" Runat="Server">
    <div id="cssmenu2">
        <ul style="font-size: small">
            <li class="active"><a><span class="fa fa-plus-circle fa-lg"></span>&nbsp;Add Activity</a></li>
        </ul>
    </div>
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td style="width: 1px; height: 35px;">:</td>
            <td style="height: 35px">
            ...
            <td style="height: 35px">
                ...
                <%--<calendarextender ID="txtEndDate_CalendarExtender" runat="server" BehaviorID="txtEndDate_CalendarExtender" TargetControlID="txtEndDate" Format="dd-MMM-yyyy" />--%>
            </td>
        </tr>
        <tr>
            ...
            <td style="width: 1px; height: 85px;">:</td>
            <td style="height: 85px">
                ...
                <%--<calendarextender ID="txtDeadline_CalendarExtender" runat="server" BehaviorID="txtDeadline_CalendarExtender" TargetControlID="txtDeadline" Format="dd-MMM-yyyy" />--%>
            </td>
            <td style="height: 85px">
                </td>
            <td style="height: 85px">

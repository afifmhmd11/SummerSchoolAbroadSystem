<%@ Page Title="ACAD2016." Language="C#" MasterPageFile="~/UTMIAR/UTMIRMasterPage.master" AutoEventWireup="true" CodeFile="frmViewProg.aspx.cs" Inherits="UTMIAR_frmViewProg" %>

<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" Runat="Server">
    <div id="cssmenu2">
        <ul style="font-size: small">
            <li class="active"><a><span class="fa fa-file-text fa-lg"></span>&nbsp;Programme Details</a></li>
        </ul>
    </div>

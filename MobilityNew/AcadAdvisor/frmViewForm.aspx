<%@ Page Title="" Language="C#" MasterPageFile="~/AcadAdvisor/AAMasterPage.master" AutoEventWireup="true" CodeFile="frmViewForm.aspx.cs" Inherits="AcadAdvisor_frmViewForm" %>
        ...
        <table class="nav-justified">
            ...
            <tr>
                <td style="background-color: #FFFBD6" colspan="6">
                    <asp:Repeater ID="rptSubjects" runat="server" DataSourceID="SqlDataSource1">
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <asp:Label ID="lblUtmSubCode" runat="server" Text='<%# Eval("UTMCODE") %>' />
                                </td>
                                <td>
                                    <asp:Label ID="lblUtmSubName" runat="server" Text='<%# Eval("UTMSUBJECTNAME") %>' />
                                </td>
                                <td>
                                    <asp:Label ID="lblUtmSubCredit" runat="server" Text='<%# Eval("CREDIT") %>' />
                                </td>
                                <td>
                                    <asp:Label ID="lblHSubCode" runat="server" Text='<%# Eval("SUBJECTCODE") %>' />
                                </td>
                                <td>
                                    <asp:Label ID="lblHSubName" runat="server" Text='<%# Eval("SUBJECTNAME") %>' />
                                </td>
                                <td>
                                    <asp:Label ID="lblHSubCredit" runat="server" Text='<%# Eval("SCREDIT") %>' />
                                </td>
                                <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT HSUBJECT.UTMCODE, UTMSUBJECT.UTMSUBJECTNAME, UTMSUBJECT.CREDIT, HSUBJECT.SUBJECTCODE, HSUBJECT.SUBJECTNAME, HSUBJECT.SCREDIT FROM HSUBJECT INNER JOIN UTMSUBJECT ON HSUBJECT.UTMCODE = UTMSUBJECT.UTMCODE WHERE HSUBJECT.APPID = @APPID">
                        <SelectParameters>
                            <asp:SessionParameter Name="APPID" SessionField="getappid" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
            </tr>

...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" Runat="Server">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" style="margin-left: -10px">
                        ...
                        <div class="statfiller">
                            ...
                            Study Plan        : 
                            </strong> <asp:Label ID="lblStudyPlan" runat="server" Text=""></asp:Label>
                            <strong>
                            <br />
                            Acceptance Letter : 
                            </strong> <asp:Label ID="lblAcceptLetter" runat="server" Text=""></asp:Label>
                            <strong>
                            <br />
                            Bank Statement    : 
                            </strong> <asp:Label ID="lblBankStatement" runat="server" Text=""></asp:Label>
                            <strong>
                            <br />    
                            Photocopy of IC   : 
                            </strong> <asp:Label ID="lblPhotoIC" runat="server" Text=""></asp:Label>
                            <strong>
                            <br />
                            </strong>&nbsp;<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [ATTACHMENT]"></asp:SqlDataSource>--%>
                        </div>
                    </div>
                </div>
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtComment" runat="server" style="border-radius: 5px; border: 1px solid CadetBlue;" Height="67px" Width="1126px" Wrap="True" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td colspan="3" style="text-align: center">
                <asp:LinkButton ID="btnBack" runat="server" CssClass="btn btn-akad btn-sm"  PostBackUrl="~/AcadAdvisor/Dashboard.aspx"><i class="fa fa-reply"></i>&nbsp;Back</asp:LinkButton>
                &nbsp;&nbsp;&nbsp;
                <asp:LinkButton ID="btnRevert" runat="server" CssClass="btn btn-akad btn-sm" OnClick="btnRevert_Click" OnClientClick="return confirm('REJECT APPLICATION?')" ><i class="fa fa-delete"></i>&nbsp;Reject</asp:LinkButton>
                &nbsp;&nbsp;&nbsp;
        ...
        <%--<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID ="btnView" runat="server"  CommandArgument='<%#Eval("FILEPATH") %>' OnClick="btnView_Click" CausesValidation="False">
                                                <span class="fa fa-search fa-lg"></span>DOWNLOAD</asp:LinkButton>
                                        </ItemTemplate>

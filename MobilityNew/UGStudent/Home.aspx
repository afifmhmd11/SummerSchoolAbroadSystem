<%@ Page Title="" Language="C#" MasterPageFile="~/UGStudent/UGMasterPage.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="UGStudent_Home" %>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="background-color: #800000; width: 154px; text-align: center;">
                            ...
                            <asp:Button ID="Button2" runat="server" Text="Apply" PostBackUrl="" />
                        </td>
                    ...
                    <tr>
                        <td style="width: 148px; background-color: #800000; height: 41px; text-align: center;">
                            ...
                            <asp:Button ID="Button3" runat="server" Text="Apply" PostBackUrl="" />
                        </td>

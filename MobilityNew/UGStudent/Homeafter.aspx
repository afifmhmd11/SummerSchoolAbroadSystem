<%@ Page Title="" Language="C#" MasterPageFile="~/UGStudent/UGMasterPage.master" AutoEventWireup="true" CodeFile="Homeafter.aspx.cs" Inherits="UGStudent_Homeafter" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" Runat="Server">
      <div id="cssmenu2">
        <ul style="font-size: small">
            ...
            <li></li>
            <li class="inactive" style="text-align: center"><a href="ApplicationStatus.aspx">&nbsp;Inbox</a></li>
            <li></li>
        ...
        <tr>
            <td class="style158">
                <table style="width: 100%">
                    ...
                    <tr>
                        <td style="width: 148px; color: #FFFFFF; background-color: #800000; text-align: center;"><br />
                        </td>
                        <td style="width: 318px; background-color: #800000; color: #FFFFFF; text-align: center;"><strong>Research Internship</strong></td>
                        <td style="width: 28px; background-color: #FFFFFF; color: #FFFFFF; text-align: center;">&nbsp;</td>
                        <td style="color: #FFFFFF; background-color: #800000; font-size: x-large; font-weight: 700; width: 154px; text-align: center;">&nbsp;</td>
                        <td style="background-color: #800000; color: #FFFFFF; width: 293px; text-align: center;"><strong>Student Exchage</strong></td>
                    </tr>
                    <tr>
                        <td style="width: 148px; background-color: #800000; text-align: center; color: #000000;">
                    ...
                    <tr>
                        <td style="width: 148px; font-size: x-large; background-color: #800000; color: #FFFFFF; font-weight: 700; text-align: center; height: 34px;"></td>
                        <td style="width: 318px; background-color: #800000; color: #FFFFFF; font-weight: 700; text-align: center; height: 34px;">International Invitation Program</td>
                        <td style="width: 28px; text-align: center; height: 34px;"></td>
                        <td style="width: 154px; background-color: #800000; color: #FFFFFF; font-weight: 700; font-size: x-large; text-align: center; height: 34px;"></td>
                        <td style="width: 293px; background-color: #800000; color: #FFFFFF; font-weight: 700; text-align: center; height: 34px;">Summer S<strong>c</strong>hool</td>
                    </tr>
                    <tr>
                        <td style="width: 148px; background-color: #800000; height: 41px; text-align: center;">
                        ...
                        <td style="width: 154px; background-color: #800000; height: 41px; text-align: center;">
                            <span class="fa-inverse" style="font-size: x-large"><strong>SS</strong></span><br />
                            <asp:Button ID="Button4" runat="server" Text="Check Status" PostBackUrl="~/UGStudent/ApplicationStatus.aspx" />
                        </td>
                    ...
                    <tr>
                        <td style="width: 148px; font-size: x-large; font-weight: 700; color: #FFFFFF; background-color: #800000; text-align: center;">&nbsp;</td>
                        <td style="width: 318px; font-weight: 700; color: #FFFFFF; background-color: #800000; text-align: center;">Global Outreach Program</td>
                        <td style="width: 28px; text-align: center">&nbsp;</td>
                        <td style="width: 154px; text-align: center">&nbsp;</td>
                        <td style="width: 293px; text-align: center">&nbsp;</td>
                    </tr>
                    <tr>
                        <td style="width: 148px; background-color: #800000; text-align: center; height: 118px;">

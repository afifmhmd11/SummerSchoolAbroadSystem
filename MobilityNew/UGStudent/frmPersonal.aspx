<%@ Page Title="" Language="C#" MasterPageFile="~/UGStudent/UGMasterPage.master" AutoEventWireup="true" CodeFile="frmPersonal.aspx.cs" Inherits="UGStudent_frmDashboard" %>
                        ...
                        <td style="color: #FFFFFF; background-color: #FFFFFF; font-size: small; height: 19px;">
                            ...
                            <table style="width: 100%" __designer:mapid="59f">
                                ...
                                <tr __designer:mapid="5c3">
                                    <td style="color: #000000; width: 110px; height: 26px;" __designer:mapid="5c4">Passport Number:</td>
                                    <td style="color: #000000; width: 178px; height: 26px;" __designer:mapid="5c5">
                                        <asp:TextBox runat="server" ID="txtPassportNumber" class="form-control" Height="25px" Width="160px" ></asp:TextBox>
                                    </td>
                                    <td style="color: #000000; width: 49px; height: 26px;" __designer:mapid="5ca"></td>
                                    <td style="color: #000000; width: 149px; text-align: left; height: 26px;" __designer:mapid="5cb">Passport Expired Date:</td>
                                    <td style="color: #000000; height: 26px;" __designer:mapid="5cc">
                                        <asp:TextBox runat="server" ID="txtPassportExpiredDate" class="form-control" Height="25px" Width="160px"></asp:TextBox>
                                        <ajaxToolkit:CalendarExtender ID="txtPassportExpiredDate_CalendarExtender" runat="server" BehaviorID="txtPassportExpiredDate_CalendarExtender" TargetControlID="txtPassportExpiredDate" Format="dd/MM/yyyy">
                                ...
                                <tr __designer:mapid="5d0">
                                    ...
                                    <td style="color: #000000; width: 49px;" __designer:mapid="5d4">
                            ...
                            <br __designer:mapid="5da" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<table style="width: 100%" __designer:mapid="591">
                                            <tr __designer:mapid="592">
                                                ...
                                                <td style="width: 105px" __designer:mapid="594">
                                                ...
                                                <td style="width: 60px" __designer:mapid="596">
                                                    <asp:Button ID="btnSave2" runat="server" ForeColor="Black" Text="Save &amp; Continue" CssClass="btn-sm" OnClick="btnSave2_Click"  />

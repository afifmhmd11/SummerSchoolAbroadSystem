<%@ Page Title="" Language="C#" MasterPageFile="~/UGStudent/UGMasterPage.master" AutoEventWireup="true" CodeFile="frmFinancial.aspx.cs" Inherits="UGStudent_frmFinancialaspx" %>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td style="color: #FFFFFF; background-color: #FFFFFF; font-size: small; height: 19px;">
                            ...
                            <table style="width: 100%; height: 55px;" __designer:mapid="61a">
                                ...
                                <tr __designer:mapid="620">
                                    <td style="color: #000000; height: 20px;" __designer:mapid="621">
                                        ...
                                        <asp:CheckBox ID="chckSelf" runat="server" Text="Self-sponsored" AutoPostBack="True" OnCheckedChanged="chckSelf_CheckedChanged" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:CheckBox ID="chckSponsor" runat="server" AutoPostBack="True" Text="Sponsor" OnCheckedChanged="chckSponsor_CheckedChanged" />&nbsp;
                                       <%-- <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" Text="Sponsor" OnCheckedChanged="chckSponsor_CheckedChanged" />&nbsp;--%>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                    ...
                                                    <asp:Panel ID="Panel1" runat="server" Visible="False" Width="305px">
                                                        <table style="width: 41%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox runat="server" ID="txtSponsorName"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="color: #000000; width: 122px">Document:</td>
                                                                <td>
                                                                    <asp:FileUpload runat="server" ID="upldSponsor">
                                                                    </asp:FileUpload>
                                                                </td>
                                                            </tr>
                                                        </table>
                            ...
                            <asp:Panel ID="Panel2" runat="server" Visible="False" Width="438px">
                                <table style="width: 91%; height: 232px">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: #000000">Program fee
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtProgramFee" Display="Dynamic" ErrorMessage="Program Fee" ForeColor="#FF3300">*</asp:RequiredFieldValidator>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: #000000">Transportation&nbsp;
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtTransportation" Display="Dynamic" ErrorMessage="Transportation" ForeColor="Red">*</asp:RequiredFieldValidator>
                                        </td>
                                        <td style="color: #000000; width: 154px;">
                            ...
                            <asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red" HeaderText="Please fill up all field" />
                                    <br />
                            ...
                            <br __designer:mapid="629" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<table style="width: 100%" __designer:mapid="591">
                                            <tr __designer:mapid="592">
                                                ...
                                                <td style="width: 60px" __designer:mapid="596">
                                                    <asp:Button ID="btnSave4" runat="server" ForeColor="Black" Text="Save &amp; Continue" CssClass="btn-sm" OnClick="btnSave4_Click" />
